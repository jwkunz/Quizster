# Quiztik Build and Release Plan (Finalized Commit + Archive Rules)

## Summary
Implement Quiztik in staged minor versions starting at `v0.0.0`, with one git commit per minor bump.
